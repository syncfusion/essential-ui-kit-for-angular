...
@Component({
    selector: 'app-ai-floating-widget-3',
    standalone: true,
    imports: [DialogModule, TextAreaModule, TextBoxModule, UploaderModule, ButtonModule, SwitchModule],
    templateUrl: './ai-floating-widget-3.component.html',
    styleUrl: './ai-floating-widget-3.component.css'
})
export class AiFloatingWidget3Component implements OnInit, OnDestroy {

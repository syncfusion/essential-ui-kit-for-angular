...
@Component({
    selector: 'app-ai-floating-menu-2',
    standalone: true,
    imports: [CommonModule, DialogModule, TextBoxModule, TextAreaModule, UploaderModule, ButtonModule, FabModule],
    templateUrl: './ai-floating-menu-2.component.html',
    styleUrl: './ai-floating-menu-2.component.css'
})
export class AiFloatingMenu2Component implements OnInit, OnDestroy {

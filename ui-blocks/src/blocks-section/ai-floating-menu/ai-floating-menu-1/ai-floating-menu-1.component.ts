...
@Component({
    selector: 'app-ai-floating-menu-1',
    standalone: true,
    imports: [CommonModule, AIAssistViewModule, DialogModule, ButtonModule, FabModule],
    templateUrl: './ai-floating-menu-1.component.html',
    styleUrl: './ai-floating-menu-1.component.css'
})
export class AiFloatingMenu1Component implements OnInit, OnDestroy {
